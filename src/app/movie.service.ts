...
// const API = 'https://669a42939ba098ed61fef782.mockapi.io/Movie';
// const API = 'http://localhost:4000';
//const API = 'https://node-proclink.onrender.com';
const API = 'https://node-2wd5.onrender.com';
...
export class MovieService {
  ...
  deleteMovie(movie: IMovie) {
    return fetch(`${API}/movies/${movie.movieId}`, { method: 'Delete' }).then(
      (res) => res.json()
    );
  }
